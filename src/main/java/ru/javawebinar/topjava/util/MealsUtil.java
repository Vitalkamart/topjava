...
public class MealsUtil {
    public static Collection<MealWithExceed> getWithExceeded(Collection<Meal> meals, int calories) {
        return getFilteredWithExceeded(meals, LocalTime.MIN, LocalTime.MAX, calories);
    }
    public static Collection<MealWithExceed> getFilteredWithExceeded(Collection<Meal> meals, LocalTime startTime, LocalTime endTime, int caloriesPerDay) {
