...
public class JdbcMealRepositoryImpl implements MealRepository {
    ...
    private static final RowMapper<Meal> ROW_MAPPER = new RowMapper() {
        @Override
        public Object mapRow(ResultSet rs, int irowNum) throws SQLException {
    ...
    public Meal get(int id, int userId) {
        ...
        return CollectionUtils.isEmpty(mealList) ? null : DataAccessUtils.singleResult(mealList);
    }
